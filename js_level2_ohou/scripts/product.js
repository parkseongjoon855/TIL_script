...
function orderFunc(){
    //console.log(0);//정상확인
    //console.log(colorSelect.value);//사이즈 색상 값 확인
    ...
    //orderSelect 출력 조건-> color의 value값이 존재하는 option선택 후 size의 value값이 option을 추가로 선택했을 경우
...
//초기 설정
orderNum.value = num;
//증가 +버튼 클릭 시 1씩 증가되서 orderNum 출력
